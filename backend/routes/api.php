...
use App\Http\Controllers\Api\DanhMucTieuChuanController;
...
Route::apiResource('danh-muc-tieu-chuan', DanhMucTieuChuanController::class)->only(['index', 'store', 'update', 'destroy']);
